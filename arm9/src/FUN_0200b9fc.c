/*
 * FUN_0200b9fc.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x0200b9fc (load base 0x02000000).
 ...
 * a host-side symbol named "FUN_0200b9fc".  When the underlying function
...
void FUN_0200b9fc(int param_1, int param_2)
{
