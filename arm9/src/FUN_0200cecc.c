/*
 * FUN_0200cecc.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x0200cecc (load base 0x02000000).
 ...
 * a host-side symbol named "FUN_0200cecc".  When the underlying function
...
void FUN_0200cecc(int param_1, int param_2)
{
