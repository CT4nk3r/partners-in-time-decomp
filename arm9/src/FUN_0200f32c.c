/*
 * FUN_0200f32c.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x0200f32c (load base 0x02000000).
 ...
 * a host-side symbol named "FUN_0200f32c".  When the underlying function
...
void FUN_0200f32c(int param_1, int param_2)
{
