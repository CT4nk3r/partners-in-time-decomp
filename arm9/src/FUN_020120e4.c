/*
 * FUN_020120e4.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x020120e4 (load base 0x02000000).
 ...
 * a host-side symbol named "FUN_020120e4".  When the underlying function
...
void FUN_020120e4(int param_1, int param_2)
{
