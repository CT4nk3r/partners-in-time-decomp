/*
 * FUN_02012bec.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x02012bec (load base 0x02000000).
 ...
 * a host-side symbol named "FUN_02012bec".  When the underlying function
...
void FUN_02012bec(int param_1, int param_2)
{
