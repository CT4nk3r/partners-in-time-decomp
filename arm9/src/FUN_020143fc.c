/*
 * FUN_020143fc.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x020143fc (load base 0x02000000).
 ...
 * a host-side symbol named "FUN_020143fc".  When the underlying function
...
void FUN_020143fc(int param_1, int param_2)
{
