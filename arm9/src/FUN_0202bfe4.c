/*
 * FUN_0202bfe4.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x0202bfe4 (load base 0x02000000).
 ...
 * a host-side symbol named "FUN_0202bfe4".  When the underlying function
...
void FUN_0202bfe4(int param_1, int param_2)
{
