/*
 * FUN_0203d76c.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x0203d76c (load base 0x02000000).
 ...
 * a host-side symbol named "FUN_0203d76c".  When the underlying function
...
void FUN_0203d76c(int param_1, int param_2)
{
