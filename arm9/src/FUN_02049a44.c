/*
 * FUN_02049a44.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x02049a44 (load base 0x02000000).
 ...
 * a host-side symbol named "FUN_02049a44".  When the underlying function
...
void FUN_02049a44(int param_1, int param_2)
{
