/*
 * FUN_02049ddc.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x02049ddc (load base 0x02000000).
 ...
 * a host-side symbol named "FUN_02049ddc".  When the underlying function
...
void FUN_02049ddc(int param_1, int param_2)
{
