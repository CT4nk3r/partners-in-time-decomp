/*
 * FUN_02049ebc.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x02049ebc (load base 0x02000000).
 ...
 * a host-side symbol named "FUN_02049ebc".  When the underlying function
...
void FUN_02049ebc(int param_1, int param_2)
{
