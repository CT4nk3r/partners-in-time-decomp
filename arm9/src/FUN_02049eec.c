/*
 * FUN_02049eec.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x02049eec (load base 0x02000000).
 ...
 * a host-side symbol named "FUN_02049eec".  When the underlying function
...
void FUN_02049eec(int param_1, int param_2)
{
