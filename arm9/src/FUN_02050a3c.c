/*
 * FUN_02050a3c.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x02050a3c (load base 0x02000000).
 ...
 * a host-side symbol named "FUN_02050a3c".  When the underlying function
...
void FUN_02050a3c(int param_1, int param_2)
{
