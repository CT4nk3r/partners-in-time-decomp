/*
 * FUN_020561d4.c — auto-generated stub by tools/scripts/auto_decomp_leaf.py
 *
 * Source: arm9.bin @ 0x020561d4 (load base 0x02000000).
 * Raw ARM instruction words (little-endian):
 *
 *   020561d4  e12fff1e
 *
 * This translation unit exists so the fnptr-table generator picks up
 * a host-side symbol named "FUN_020561d4".  When the underlying function
...
void FUN_020561d4(int param_1, int param_2)
{
    /* immediate return */
}
