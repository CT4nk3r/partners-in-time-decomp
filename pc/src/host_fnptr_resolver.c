...
static void host_fnptr_register_overrides(void)
{
    ...
    /* OV0 sprite/tile processing state machine — let it run via interpreter;
     * loop detection will break out of uninitialized sprite table scans. */
    /* register_safe(0x0206C34Cu, (void *)native_noop); -- removed, needed for gameplay */
